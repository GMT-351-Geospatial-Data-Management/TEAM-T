...
- finally you can start the app with the 'python manage.py runserver' command, then click with ctrl to "[http://...](http://127.0.0.1:8000/)" link which appeared in the terminal.
